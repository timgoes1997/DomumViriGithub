...
// Set host and port 
    public static final String HOSTNAME = "188.166.2.36"; //"192.168.0.100"
...
//        System.out.println("server deleted (expected true): " + client.deleteServer("testserver", "48.50.50.50", 123));
//    }
}
